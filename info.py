...
PICS = (environ.get('PICS', 'https://envs.sh/ylk.jpg https://envs.sh/yl9.jpg https://envs.sh/yls.jpg https://envs.sh/yl9.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/yl9.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://graph.org/file/60e8a622b14796e4448ce.mp4")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/13702ae26fb05df52667c.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://graph.org/file/242b7f1b52743938d81f1.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://envs.sh/ykh.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7658557284').split()] # Replace with the actual admin ID(s) to add
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002038476381'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('VASU', '-1002273993972'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002038476381'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002077433895')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002077433895').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002077433895').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://t.me/TrickiVasuBot')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'USE FREE')

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Vasu:%40Vasu2412@cluster0.2ajb6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://vasu24122006:%40Vasu2412@cluster0.w3cmc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "vasu")
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/c/2041246768/241')  # How to open tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/BhediyaTheater')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Bhediya_Updates2')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/TrickiVasuBot')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/Bhediya_Updates2')
OWNERID = int(os.environ.get('OWNERID', '7658557284'))  # Replace with the actual admin ID
